...
The objective of this project is to build a text classification model capable of predicting the category of a customer's complaint based on the complaint text.
